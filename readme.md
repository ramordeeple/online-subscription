...
| Database        | PostgreSQL                                                                      |
| Migrations      | SQL файлы + встроенный runner                                                   |
...
* 🐳 Docker Desktop
* 💻 Go 1.25+
* 🛠️ Любой HTTP клиент (**Postman**, встроенный в **GoLand**)

---

### 2️⃣ Настройка переменных окружения

В файле `.env` (или напрямую в Docker Compose):
...
> 💡 Либо же ПКМ по `docker-compose.yml` и нажать на `Run 'docker-compose.yml'`.

Будут применены указанные ниже данные для базы данных из `.env`
